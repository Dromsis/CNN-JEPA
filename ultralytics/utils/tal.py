...
class TaskAlignedAssigner(nn.Module):
    ...
    def iou_calculation(self, gt_bboxes, pd_bboxes):
        ...
        if metrics.USE_NWD:  # YOLO-SEA tiny-object blend; assigner boxes are already in pixel units
            iou = (1 - metrics.NWD_RATIO) * iou + metrics.NWD_RATIO * wasserstein_similarity(gt_bboxes, pd_bboxes)
